...
Another condition we've added is to ascertain if the input density is constant, i.e uniform (either dunif() or any constant function), and then just sample uniformly using runif from the domain. 
